...
opts[1].metropolis_hastings()

opts[0].generate_samples(5,{},runLocal=forwardModels.rosenbrock)
opts[1].generate_samples(5,{},runLocal=forwardModels.rosenbrock)
opts[2].generate_samples(1,{},runLocal=forwardModels.rosenbrock)
